...
public class CardUtils {
    final public static int DIRECTION_TOP_LEFT = 0;
    final public static int DIRECTION_TOP_RIGHT = 1;
    final public static int DIRECTION_BOTTOM_LEFT = 2;
    final public static int DIRECTION_BOTTOM_RIGHT = 3;
