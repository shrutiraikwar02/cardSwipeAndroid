...
import com.cardswipe.swipeLib.animation.RelativeLayoutParamsEvaluator;

import java.util.ArrayList;
import java.util.HashMap;

import static com.cardswipe.swipeLib.cardstack.CardUtils.cloneParams;
import static com.cardswipe.swipeLib.cardstack.CardUtils.getMoveParams;
import static com.cardswipe.swipeLib.cardstack.CardUtils.move;
import static com.cardswipe.swipeLib.cardstack.CardUtils.scale;
...
public class CardAnimator {
     ...
     *
     * Call {@link #initLayout()} after setting to reinitialize the layout
     *
     * @param gravity {@link #TOP} Improvement {@link #BOTTOM} Down, default
     */
    ...
    private void moveToBack(View child) {
        ...
        if (null != parent) {
            ...
            parent.addView(child, 0); // Move to the last

        }
    }

    // Sort the cards, draw one, and one at the bottom
